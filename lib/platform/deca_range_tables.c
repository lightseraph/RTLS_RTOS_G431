...
const uint8 chan_idxnb[8] = {0, 0, 1, 2, 0, 3, 0, 0}; // only channels 1,2,3 and 5 are in the narrow band tables
const uint8 chan_idxwb[8] = {0, 0, 0, 0, 0, 0, 0, 1}; // only channels 4 and 7 are in in the wide band tables
