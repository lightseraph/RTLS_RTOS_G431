...
#define SET_WAKEUP_PIN_IO_LOW HAL_GPIO_WritePin(DW_WUP_GPIO_Port, DW_WUP_Pin, GPIO_PIN_RESET)
#define SET_WAKEUP_PIN_IO_HIGH HAL_GPIO_WritePin(DW_WUP_GPIO_Port, DW_WUP_Pin, GPIO_PIN_SET)
